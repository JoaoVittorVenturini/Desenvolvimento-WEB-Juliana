...
function calculateAverage() {
  ...
  document.getElementById("result").innerHTML = `
      <h2 class="justify-content-center align-content-center d-flex my-2 fs-2">Resultado</h2>
      <h4 class="my-2 fs-4">A media do aluno "<span id="student">${student.value}</span>" está <span id="situation" class="${color}">${situation}</span> com média: <span id="average">${average.toFixed(1)}</span></h4>
  `;
}